...
export const Menus = connect(mapStateToProps)(function Menus(props) {
	useEffect(() => {
		...
		if (process.platform !== 'darwin') {
			...
			getCurrentWindow().setAutoHideMenuBar(!hasMenus);
			getCurrentWindow().setMenuBarVisibility(!!hasMenus);
		}
	});
